...
def main():
    ...
    for idx, reel_url in enumerate(reels_urls[:target_count], start=1):
        ...
        posts_data.append({
            ...
            "caption": caption.strip() if caption else "Naturae Nutribar - Saúde, frescor e sabor para o seu dia!",
    ...
    print("\n✅ Concluído! Vídeos do Naturae Nutribar comprimidos em 720p e salvos.")
